                                    ...
                                    <td style="width: 50%;" rowspan="2">
                                        ...
                                        <td style="width: 25%;">
                                            <div  class="dashboard-items search-items"  >
                                                ...
                                                <div class="dashboard-items search-items text-center mt-4">
                                                <div class="alert alert-info" role="alert">
                                                    <h4 class="alert-heading">Complaints</h4>
                                                        ...
                                                        <textarea class="form-control" name="complaints" rows="4" style= "margin-left:10px;padding-left: 25px;padding-right: 10px;padding-top: 10px;padding-bottom: 10px;width:95%;text-align: center;" placeholder="Please describe your complaints" required></textarea>
                                                        </div>
