...
<body>
    ...
    $sqlmain = "SELECT pname, pid, diagnosis, prescription FROM reports WHERE pid = '$userid'";
    ...
    <div class="container">
        <div class="menu">
            <table class="menu-container" border="0">
                ...
                <tr class="menu-row" >
                    <td class="menu-btn menu-icon-records menu-active menu-icon-doctor-active">
...
?>
                ...
                <?php
                    if($_POST){
                        ...
                        $sqlmain= "select * from reports where pid='$keyword' or pname='$keyword' or pname like '$keyword%' or pname like '%$keyword' or pname like '%$keyword%'";
                    }else{
                        $sqlmain= "select * from reports order by rid desc";
                        ...
                        <tbody>
                            ...
                            if ($result->num_rows == 0) {
                                ...
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    <td>' . (isset($row['pid']) ? substr($row['pid'], 0, 20) : '') . '</td>
                                    <td>' . (isset($row['diagnosis']) ? substr($row['diagnosis'], 0, 20) : '') . '</td>
                                    <td>' . (isset($row['prescription']) ? substr($row['prescription'], 0, 20) : '') . '</td>
